...
//		add_action( 'init', array( $this, 'admin_editor_style' ) );
	...
	public function global_assets() {
		...
		wp_enqueue_style( 'app', THEME_URI . 'dist/assets/css/app.css', [], THEME_VERSION, 'all' );
		wp_enqueue_script( 'app', THEME_URI . 'dist/assets/js/app.js', [], THEME_VERSION, true );
		wp_localize_script( 'app', 'custom', [
			'restURL' => rest_url(),
	...
	public function global_variables( $handle ) {
		$accent_1 = get_field( 'settings_accent_1', 'options' ) ?: [
			'red' => '174',
			'green' => '144',
			'blue' => '255'
		];
